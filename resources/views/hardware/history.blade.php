                    ...
                    <div class="col-md-12">
                        <form class="form-horizontal" role="form" method="post" enctype="multipart/form-data" action="">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    {{ Form::checkbox('match_firstnamelastname', '1', Input::old('match_firstnamelastname')) }} 通过名和姓匹配
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    {{ Form::checkbox('match_flastname', '1', Input::old('match_flastname')) }} 通过姓来匹配
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    {{ Form::checkbox('match_firstname', '1', Input::old('match_firstname')) }} 试图通过名来匹配
                                </div>
                            </div>
